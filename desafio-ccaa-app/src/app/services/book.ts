  ...
  private books: Book[] = [
    {
      ...
      coverImage: 'https://via.placeholder.com/150x200/4CAF50/FFFFFF?text=Senhor+dos+Aneis',
      stockQuantity: 15,
      isAvailable: true,
    ...
    },
    {
      ...
      coverImage: 'https://via.placeholder.com/150x200/2196F3/FFFFFF?text=Dom+Casmurro',
      stockQuantity: 8,
      isAvailable: true,
    ...
    },
    {
      ...
      coverImage: 'https://via.placeholder.com/150x200/FF9800/FFFFFF?text=Poder+do+Habito',
      stockQuantity: 12,
      isAvailable: true,
    ...
    },
    {
      ...
      coverImage: 'https://via.placeholder.com/150x200/9C27B0/FFFFFF?text=Steve+Jobs',
      stockQuantity: 6,
      isAvailable: true,
    ...
    },
    {
      ...
      coverImage: 'https://via.placeholder.com/150x200/607D8B/FFFFFF?text=Batman+Ano+Um',
      stockQuantity: 10,
      isAvailable: true,
